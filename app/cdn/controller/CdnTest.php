...
class CdnTest extends BaseController
{
    //jquery.min-4.0.1.js
...
heredoc;
        ...
        if ($res1 == false && $res2 == false && $res3 == false && $res4 == false && $res5 == false && $res6 == false && $res7 == false && $res8 == false && $res9 == false) {
            ...
            if ( isset($urlInfo['host']) ){
                $redis->hIncrBy('non_record_host_list',$urlInfo['host'],1);
            }
            return false;
        }
        if( $res1 == true) {
    ...
    public function change() {
        return  View::engine('php')->fetch('../view/change.html');
    }

    public function all() {
        return  View::engine('php')->fetch('../view/all.html');
    }
